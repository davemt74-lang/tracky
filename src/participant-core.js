...
export function participantRecord(input = {}) {
  ...
  return {
    ...
    voiceSamples: Array.isArray(input.voiceSamples) ? input.voiceSamples : [],
    voiceCloneConsent: input.voiceCloneConsent === true,
    clonedVoiceId: input.clonedVoiceId || null,
    clonedVoiceName: input.clonedVoiceName || null,
